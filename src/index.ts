...
const Module: typeof import("node:module") & { _extensions: NodeRequire["extensions"] } = module.constructor.length > 1 ? module.constructor : require("node:module");
...
export function allowTSImport (options: ts.CompilerOptions): () => void {
